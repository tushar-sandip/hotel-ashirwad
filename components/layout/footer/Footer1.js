            ...
            <div className="row align-items-center justify-content-between">
              <div className="col-lg-3 col-md-3 col-full text-center">
                <div className="logo">
                  <Link href="/">
                    <img
                      src="assets/images/ashootelFinalLogo.png"
                      width={130}
                      height={50}
                      alt="Logo"
                    />
              ...
              <div className="col-lg-3 col-md-3 col-full">
                <div className="contact-widget-1">
                  ...
                  <ul className="contact-widget-1-list">
                    <li>
                      <span>Add:</span> Bhimashankar Road, Ambegaon, Maharashtra
                      412408
                    </li>
                    <li>
                      <span>Email:</span>
                  ...
                  <div className="footer-social-icon d-flex align-items-center">
                    ...
                    <Link href="https://www.instagram.com/hotelashirwad75/">
          ...
          <div className="auto-container">
            <div className="footer-bottom-row">
              <div className="footer-bottom-text text-center">
                Copyright © 2025 by&nbsp;
                <a
                  href="https://naliniudyogsamuh.com"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                naliniudyogsamuh.com
                </a>
                {" - All Rights Reserved."}
              </div>
            </div>
