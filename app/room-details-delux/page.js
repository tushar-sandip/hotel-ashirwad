...
export default function Home() {
  ...
  const images = [
    { original: "/assets/Rooms/room7.jpeg", thumbnail: "/assets/Rooms/room7.jpeg" },
    { original: "/assets/Rooms/room6.jpeg", thumbnail: "/assets/Rooms/room6.jpeg" },
  ...
  return (
    <>
      <Layout headerStyle={3} footerStyle={1} breadcrumbTitle="Delux Single Bed Room">
        <div>
              ...
              <div className="row">
                <div className="col-lg-8 pe-lg-35">
                  <div className="single-post">
                    ...
                    <h2 className="mb_40 modern-title">Delux Single Bed Room</h2>
                    ...
                    <div className="modern-gallery mb_60">
                      {!show360 ? (
                        ...
                        <div style={{ height: 400, borderRadius: 12, overflow: "hidden", boxShadow: "0 2px 16px rgba(0,0,0,0.08)" }}>
                          <PSV src="/assets/images/gallery/room360.jpg" />
                        </div>
                      )}
                    </div>
                    <p className="mb_20">
