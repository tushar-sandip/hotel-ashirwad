  ...
  const menuCategories = [
    {
      ...
      items: [
        ...
        { name: "Paneer Masala (पनीर मसाला)", price: 110, description: "Paneer cooked in a rich and spicy gravy.", image: "ashootelFinalLogo.png" },
        { name: "Mutter Paneer (मटर पनीर)", price: 110, description: "Paneer and peas in a mildly spiced curry.", image: "mutter-paneer.jpg" },
        { name: "Paneer Butter Masala (पनीर बटर मसाला)", price: 120, description: "Paneer in a creamy butter-based gravy.", image: "paneer-butter-masala.jpg" },
        { name: "Palak Paneer (पालक पनीर)", price: 110, description: "Paneer cooked with fresh spinach leaves.", image: "palak-paneer.jpg" },
        { name: "Paneer Kadai (पनीर कढाई)", price: 170, description: "Paneer cooked in a traditional wok with spices.", image: "paneer-kadai.jpg" },
        { name: "Paneer Tikka Masala (पनीर टिक्का मसाला)", price: 130, description: "Grilled paneer in a spiced tomato gravy.", image: "paneer-tikka-masala.jpg" },
        { name: "Shahi Paneer (शाही पनीर)", price: 130, description: "Royal paneer cooked with rich ingredients.", image: "shahi-paneer.jpg" },
        { name: "Paneer Methi Mutter Malai (पनीर मेथी मटर मलाई)", price: 120, description: "Paneer, fenugreek, and peas in a creamy sauce.", image: "paneer-methi-mutter-malai.jpg" },
        { name: "Malai Kofta (मलाई कोप्ता)", price: 170, description: "Fried dumplings of paneer in a creamy gravy.", image: "malai-kopta.jpg" },
        { name: "Paneer Malavani (पनीर मालवणी)", price: 200, description: "Paneer cooked with Malvani spices.", image: "paneer-malavani.jpg" },
        { name: "Paneer Chilli (पनीर चिल्ली)", price: 140, description: "Paneer stir-fried with Chinese spices.", image: "paneer-chilly.jpg" },
        { name: "Paneer Bhurji (पनीर भुर्जी)", price: 120, description: "Scrambled paneer cooked with onions, tomatoes, and spices.", image: "paneer-bhurji.jpg" },
                ...
                <div className="sidebar-menu">
                  ...
                  <ul>
                    {menuCategories.map((category, index) => (
                      <li
                        key={index}
                        className={`menu-category-item ${openCategory === index ? 'active' : ''}`} // Add 'active' class if this category is selected
                ...
                {menuCategories.map((category, index) => (
                  <Collapse key={index} isOpened={openCategory === index}>
                    <div className="category-section mb_60">
                      <h3 className="category-title text-center">{category.category}</h3>
                      <div className="row">
                          ...
                          <div key={itemIndex} className="col-lg-6">
                            <div className="price-menu-1-block">
                              ...
                              <div className="price-menu-1-image">
                                <img src={`/assets/images/desser.jpeg`} alt={item.name} width={50} height={50}className="border-radius" />
                              </div>
                            </div>
                          </div>
                        ))}
